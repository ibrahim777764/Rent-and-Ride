...
User.create(name: 'thomas', email: 'tom@gmail.com', password: 'tom123123')
User.create(name: 'Raad', email: 'rad@gmail.com', password: 'Rad123')
User.create(name: 'afolabi', email: 'afolabi@gmail.com', password: '123123')
